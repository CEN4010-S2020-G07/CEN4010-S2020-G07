        ...
        <div class="container mt-5" id="hubBox">
            ...
            <div class="d-flex justify-content-around">
                ...
                <div class="card h-100" style="width: 16rem;">
                    <img class="card-img-top img-fluid" src="images/DagelijkseKruiswoord.png" alt="Bubble Shooter">
                    <div class="card-body placardBody">
                        <form method="post" action="gamePlacard.php">
                            <div class="form-check bForm">
                                <input type="hidden" name="placardName" value="Dagelijkse Kruiswoord">
                ...
                <!-- game Placard #2 -->
                <div class="card h-100" style="width: 16rem;">
                    <img class="card-img-top img-fluid" src="games/PilesOfTiles.png" alt="Bubble Trouble">
                    <div class="card-body placardBody">
                        <form method="post" action="gamePlacard.php">
                            <div class="form-check bForm">
                                <input type="hidden" name="placardName" value="Pile Of Tiles">
                                <button type="submit" class="btn btn_R">Play Now</button>
                            </div>
                        </form>
                    </div>
