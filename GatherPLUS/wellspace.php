        ...
        <div id="well_carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/maskR.jpg" class="w-100 carapic" alt="...">
                </div>
                <div class="carousel-item carapic">
                    <img src="images/InkedyellowmaskR.jpg" class="w-100 carapic" alt="...">
                </div>
                <div class="carousel-item carapic">
                    <img src="images/banner_familyR.jpg" class="w-100 carapic" alt="...">
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                                <p class="text-left">
                                    Novel Coronavirus, or SARS-COV-2, is a previously unidentified strain of coronavirus that is part of a larger family of coronaviruses. These viruses cause respiratory illnesses in humans (and animals) that can range from the common cold to more severe conditions such as COVID-19; which is the disease involved in the current outbreak.
                                </p>
                                <p>
                                    Coronavirus spreads through droplets that are dispersed into the air when an infected person coughs or sneezes. It is also possible to get the virus by touching a contaminated surface or object and then touching your face.
                ...
                <div class="col-sm-6">
                    <div class="card wc_height">
                        ...
                        <div class="card-body">
                            <img src="images/wellness2.jpg" class="img-fluid mt-2" alt="">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <p></p><!--this line for spacing only-->
                ...
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body text-left">
                            <img src="images/usmap.png" style="width:600px; height:400px;" alt="map" class="img-fluid">
                            <p></p>
                            <!--this line for spacing because break tag won't work-->
                            <p>Health centers are an important component of the national response to the pandemic. Call your nearest health center or health department to discover their availability for COVID-19 screening and testing.
                            </p>
                            <p>
