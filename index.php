...
<body id="fmain_body">
    ...
    <!-- Header Title -->
    <video src="images/InkedTogether_LI.mp4" type=video/mp4 width="100%" height="100%" autoplay poster="images/TogetherR.jpg"></video>
    <!-- Greeting Message -->
    <div class="container-fluid text-center section" id="maintext">
        <!-- Carousel Images -->
        <div class="col-md-8 text-center" id="welcome">
    ...
    <div class="container col-md-12 mt-3">
        ...
        // Welcomes User if they are Logged-in
            if (isset($_SESSION["username"]))
            {
                ...
                echo "<h5 class=\"alert alert-warning text-center mt-4\" style=\"width:50%; margin-left:25%;\">Please sign in for full access</h5>";
            }
        ?>
    </div>
    <!-- Hubs Catelog -->
    ...
    <!-- RSS Feed -->
    <div class="container-fluid text-center" id="weeklynews">
        <rssapp-list id="0M9op6IRkCD38SCZ"></rssapp-list>
