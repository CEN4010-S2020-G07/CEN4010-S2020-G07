...
<html lang="en">
    ...
    <body>
        ...
        <nav id="navigate" class="navbar navbar-expand-xl navbar-fixed-top navbar-light bg-light">
         ...
         <!-- Hero Image -->
         <div class="container col-md-12 hero"><!--<video src="images/InkedGamesResize_LI.mp4" type=video/mp4 width="100%" height="80%" autoplay poster="images/InkedGamesResize_LI.jpg"></video>--> <img src="images/GamesR.jpg" alt="Games" class="img-fluid w-100">
         </div>
        
        <!--Game Placards List-->
        <div class="container" id="GhubBox">
