...
<html lang="en">
    ...
    <body>
        ...
        <!-- Hero Image -->
        <div class="container col-md-12 hero"><!--<video src="images/InkedReadingR_LI.mp4" type=video/mp4 width="100%" height="100%" autoplay poster="images/InkedReadingR_LI.jpg"></video>--> <img src="images/ReadingRS2.jpg" alt="Books" class="img-fluid w-100">
        </div>
