...
<html lang="en">
    ...
    <body>
        ...
        <nav id="navigate" class="navbar navbar-expand-xl navbar-fixed-top navbar-light bg-light">
         ...
         <!-- Hero Image -->
         <div class="container col-md-12 hero"><video src="images/InkedHearingR_LI.mp4" type=video/mp4 width="100%" height="100%" autoplay poster="images/InkedHearingR_LI.jpg"></video>
         </div>
        ...
        <div class="container mt-5" id="audiohub">
            ...
            <div class="d-flex justify-content-around mt-5">
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Award-Winning Journalism</div>
                    </div>
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Inspiration</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Insight on Life and Finance</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
             ...
             <!-- <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Insert Here</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
            ...
            <div class="d-flex justify-content-around">
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Political Discussion</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Soulful Music</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
                ...
                <div class="card h-100" style="width: 16rem;">
                    ...
                    <div class="overlay">
                        <div class="text">Life, Fun, and Spirituality</div>
                    </div>
                    <div class="card-body placBody">
                        <form method="post" action="podPlacard.php">
                            <div class="form-check bForm">
